...
namespace C3_Form_testing
{
    public partial class Form1 : Form
    {
        ...
        struct MyFildCardstatus
        { public int FildHP_status, FildATK_status; }
        struct AiCardstatus
        ...
        public void Card_FildFull_Fildnull()
        {
            if (Fildbool1 == 0) 
        ...
        {
            if (Fildbool1 == 1) { button6.Enabled = true; button6.Text = "사용 하기"; }
            else { button6.Visible = false; }
            if (Fildbool2 == 1) { button7.Enabled = true; button7.Text = "사용 하기"; }
            else { button7.Visible = false; }
            if (Fildbool3 == 1) { button8.Enabled = true; button8.Text = "사용 하기"; }
            else { button8.Visible = false; }
            if (Fildbool4 == 1) { button9.Enabled = true; button9.Text = "사용 하기"; }
            else { button9.Visible = false; }
            if (Fildbool5 == 1) { button10.Enabled = true; button10.Text = "사용 하기"; }
        ...
        private void DeleteCard_button(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (Fildbool1 == 0) { button6.Visible = false; }
                if (Fildbool2 == 0) { button7.Visible = false; }
                if (Fildbool3 == 0) { button8.Visible = false; }
                if (Fildbool4 == 0) { button9.Visible = false; }
                if (Fildbool5 == 0) { button10.Visible = false; }
                ...
                else
                {
                    ...
                    Card_FildFull_Fildnull(); buttonTrue_False(); button12.Visible = true;
                }
        ...
        Rectangle[] FildRectangle ={ new Rectangle(pictureBox1.Location.X - 2, pictureBox1.Location.Y - 2, 163, 225),
            ...
            if (e.Button == MouseButtons.Left && button11.Visible == true)
            {
                ...
                for (int j = 0; j <= 9; j++)
                {
                    if (AiFildbool1 == 0)
                    {
                        ...
                        {
                            pictureBox6.Image = CardDB[j].AiMonsterCardcode; AiFildbool1 = 1;
                    ...
                    if (AiFildbool2 == 0)
                    {
                        if (CardDB[j].Aikeycode == Card_Number.Next(0, 9))
                        {
                            pictureBox7.Image = CardDB[j].AiMonsterCardcode; AiFildbool2 = 1;
                    ...
                    if (AiFildbool3 == 0)
                    {
                        if (CardDB[j].Aikeycode == Card_Number.Next(0, 9))
                        {
                            pictureBox8.Image = CardDB[j].AiMonsterCardcode; AiFildbool3 = 1;
                    ...
                    if (AiFildbool4 == 0)
                    {
                        if (CardDB[j].Aikeycode == Card_Number.Next(0, 9))
                        {
                            pictureBox9.Image = CardDB[j].AiMonsterCardcode; AiFildbool4 = 1;
                    ...
                    if (AiFildbool5 == 0)
                    {
                        if (CardDB[j].Aikeycode == Card_Number.Next(0, 9))
                        {
                            pictureBox10.Image = CardDB[j].AiMonsterCardcode; AiFildbool5 = 1;
                ...
                { g.DrawRectangle(penblack, FildRectangle[0]); g.DrawRectangle(penblack, FildRectangle[5]); Delay(700); }
                if (Fildbool1 == 0 && AiFildbool1 == 1)
                {
                    g.DrawRectangle(penRed, FildRectangle[0]); g.DrawRectangle(penGreen, FildRectangle[5]); Delay(700);
                ...
                {
                    g.DrawRectangle(penGreen, FildRectangle[0]); g.DrawRectangle(penRed, FildRectangle[5]); Delay(700);
                ...
                BattleRectangle = 2; if (BattleRectangle == 2)
                {
                    ...
                    g.DrawRectangle(penblack, FildRectangle[1]); g.DrawRectangle(penblack, FildRectangle[6]); Delay(700);
                }
                if (Fildbool2 == 0 && AiFildbool2 == 1)
                {
                    g.DrawRectangle(penRed, FildRectangle[1]); g.DrawRectangle(penGreen, FildRectangle[6]); Delay(700);
                ...
                {
                    g.DrawRectangle(penGreen, FildRectangle[1]); g.DrawRectangle(penRed, FildRectangle[6]); Delay(700);
                ...
                BattleRectangle = 3; if (BattleRectangle == 3)
                {
                    ...
                    g.DrawRectangle(penblack, FildRectangle[2]); g.DrawRectangle(penblack, FildRectangle[7]); Delay(700);
                }
                if (Fildbool3 == 0 && AiFildbool3 == 1)
                {
                    g.DrawRectangle(penRed, FildRectangle[2]); g.DrawRectangle(penGreen, FildRectangle[7]); Delay(700);
                ...
                {
                    g.DrawRectangle(penGreen, FildRectangle[2]); g.DrawRectangle(penRed, FildRectangle[7]); Delay(700);
                ...
                BattleRectangle = 4; if (BattleRectangle == 4)
                {
                    ...
                    g.DrawRectangle(penblack, FildRectangle[3]); g.DrawRectangle(penblack, FildRectangle[8]); Delay(700);
                }
                if (Fildbool4 == 0 && AiFildbool4 == 1)
                {
                    g.DrawRectangle(penRed, FildRectangle[3]); g.DrawRectangle(penGreen, FildRectangle[8]); Delay(700);
                ...
                {
                    g.DrawRectangle(penGreen, FildRectangle[3]); g.DrawRectangle(penRed, FildRectangle[8]); Delay(700);
                ...
                BattleRectangle = 5; if (BattleRectangle == 5)
                {
                    ...
                    g.DrawRectangle(penblack, FildRectangle[4]); g.DrawRectangle(penblack, FildRectangle[9]); Delay(700);
                }
                if (Fildbool5 == 0 && AiFildbool5 == 1)
                {
                    g.DrawRectangle(penRed, FildRectangle[4]); g.DrawRectangle(penGreen, FildRectangle[9]); Delay(700);
                ...
                {
                    g.DrawRectangle(penGreen, FildRectangle[4]); g.DrawRectangle(penRed, FildRectangle[9]); Delay(700);
        ...
        private void CardAdd1_button(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                {
                    pictureBox1.Image = button1.Image; Handbool1 = 0; Fildbool1 = 1;
                    label11.Text = label1.Text; label12.Text = label2.Text;
                    MyFild_status[0].FildHP_status = Mycardstatus[0].MyHP_status;
                    MyFild_status[0].FildATK_status = Mycardstatus[0].MyATK_status;
                    Info_Card[0].Info_Fild = Info_Card[0].Info_Hand;
                ...
                {
                    pictureBox1.Image = button2.Image; Handbool2 = 0; Fildbool1 = 1;
                    label11.Text = label3.Text; label12.Text = label4.Text;
                    MyFild_status[0].FildHP_status = Mycardstatus[1].MyHP_status;
                    MyFild_status[0].FildATK_status = Mycardstatus[1].MyATK_status;
                    Info_Card[0].Info_Fild = Info_Card[1].Info_Hand;
                ...
                {
                    pictureBox1.Image = button3.Image; Handbool3 = 0; Fildbool1 = 1;
                    label11.Text = label5.Text; label12.Text = label6.Text;
                    MyFild_status[0].FildHP_status = Mycardstatus[2].MyHP_status;
                    MyFild_status[0].FildATK_status = Mycardstatus[2].MyATK_status;
                    Info_Card[0].Info_Fild = Info_Card[2].Info_Hand;
                ...
                {
                    pictureBox1.Image = button4.Image; Handbool4 = 0; Fildbool1 = 1;
                    label11.Text = label7.Text; label12.Text = label8.Text;
                    MyFild_status[0].FildHP_status = Mycardstatus[3].MyHP_status;
                    MyFild_status[0].FildATK_status = Mycardstatus[3].MyATK_status;
                    Info_Card[0].Info_Fild = Info_Card[3].Info_Hand;
                ...
                if (button5.Enabled == false && Magicbool5 == 0)
                {
                    ...
                    MyFild_status[0].FildHP_status = Mycardstatus[4].MyHP_status;
                    MyFild_status[0].FildATK_status = Mycardstatus[4].MyATK_status;
                    Info_Card[0].Info_Fild = Info_Card[4].Info_Hand;
            ...
            if (button12.Visible == false && e.Button == MouseButtons.Left)
            {
                ...
                label11.Text = ""; label12.Text = ""; Fildbool1 = 0;
                MyFild_status[0].FildHP_status = 0; MyFild_status[0].FildATK_status = 0;
                Card_FildFull_Fildnull();
                button12.Visible = true; pictureBox1.Image = NullCard;
                textBox1.Text = "필드 첫번째 카드를 버리셨습니다";
                textBox2.Text = Info_Card[0].Info_Fild = "";
                button12.Text = "카드 버리기 \r\n" + --DeleteCardcount + "/3";
            }
        }
        private void CardAdd2_button(object sender, MouseEventArgs e)
        {
            if(e.Button == MouseButtons.Left)
            {
                if (button1.Enabled == false && Magicbool1 == 0)
                {
                    pictureBox2.Image = button1.Image; Handbool1 = 0; Fildbool2 = 1;
                    label13.Text = label1.Text; label14.Text = label2.Text;
                    MyFild_status[1].FildHP_status = Mycardstatus[0].MyHP_status;
                    MyFild_status[1].FildATK_status = Mycardstatus[0].MyATK_status;
                    Info_Card[1].Info_Fild = Info_Card[0].Info_Hand;
                    button1.Image = NullCard;
                    label1.Text = ""; label2.Text = "";
                ...
                if (button2.Enabled == false && Magicbool2 == 0)
                {
                    pictureBox2.Image = button2.Image; Handbool2 = 0; Fildbool2 = 1;
                    label13.Text = label3.Text; label14.Text = label4.Text;
                    MyFild_status[1].FildHP_status = Mycardstatus[1].MyHP_status;
                    MyFild_status[1].FildATK_status = Mycardstatus[1].MyATK_status;
                    Info_Card[1].Info_Fild = Info_Card[1].Info_Hand;
                    button2.Image = NullCard;
                    label3.Text = ""; label4.Text = "";
                    button7.Text = "필드에 카드가 있습니다";
                }
                if (button3.Enabled == false && Magicbool3 == 0)
                {
                    pictureBox2.Image = button3.Image; Handbool3 = 0; Fildbool2 = 1;
                    label13.Text = label5.Text; label14.Text = label6.Text;
                    MyFild_status[1].FildHP_status = Mycardstatus[2].MyHP_status;
                    MyFild_status[1].FildATK_status = Mycardstatus[2].MyATK_status;
                    Info_Card[1].Info_Fild = Info_Card[2].Info_Hand;
                    button3.Image = NullCard;
                    label5.Text = ""; label6.Text = "";
                    button7.Text = "필드에 카드가 있습니다";
                }
                if (button4.Enabled == false && Magicbool4 == 0)
                {
                    pictureBox2.Image = button4.Image; Handbool4 = 0; Fildbool2 = 1;
                    label13.Text = label7.Text; label14.Text = label8.Text;
                    MyFild_status[1].FildHP_status = Mycardstatus[3].MyHP_status;
                    MyFild_status[1].FildATK_status = Mycardstatus[3].MyATK_status;
                    Info_Card[1].Info_Fild = Info_Card[3].Info_Hand;
                    button4.Image = NullCard;
                    label7.Text = ""; label8.Text = "";
                    button7.Text = "필드에 카드가 있습니다";
                }
                if (button5.Enabled == false && Magicbool5 == 0)
                {
                    pictureBox2.Image = button5.Image; Handbool5 = 0; Fildbool2 = 1;
                    label13.Text = label9.Text; label14.Text = label10.Text;
                    MyFild_status[1].FildHP_status = Mycardstatus[4].MyHP_status;
                    MyFild_status[1].FildATK_status = Mycardstatus[4].MyATK_status;
                    Info_Card[1].Info_Fild = Info_Card[4].Info_Hand;
                    button5.Image = NullCard;
                    label9.Text = ""; label10.Text = "";
                    button7.Text = "필드에 카드가 있습니다";
                }
                ...
                if(button1.Enabled == false && Magicbool1 > 0)
                {
                    ...
                    if(Magicbool1 == 2)
                    {
                        MyFild_status[1].FildHP_status += Magicstatus[0].Magic_status;
                        label13.Text = "" + MyFild_status[1].FildHP_status;
            ...
            if (button12.Visible == false && e.Button == MouseButtons.Left)
            {
                ...
                label13.Text = ""; label14.Text = ""; Fildbool2 = 0;
                MyFild_status[1].FildHP_status = 0; MyFild_status[1].FildATK_status = 0;
                Card_FildFull_Fildnull();
                button12.Visible = true; pictureBox2.Image = NullCard;
                textBox1.Text = "필드 두번째 카드를 버리셨습니다";
                textBox2.Text = Info_Card[1].Info_Fild = "";
                button12.Text = "카드 버리기 \r\n" + --DeleteCardcount + "/3";
            }
        }
        private void CardAdd3_button(object sender, MouseEventArgs e)
        {
            if(e.Button == MouseButtons.Left)
            {
                if (button1.Enabled == false && Magicbool1 == 0)
                {
                    pictureBox3.Image = button1.Image; Handbool1 = 0; Fildbool3 = 1;
                    label15.Text = label1.Text; label16.Text = label2.Text;
                    MyFild_status[2].FildHP_status = Mycardstatus[0].MyHP_status;
                    MyFild_status[2].FildATK_status = Mycardstatus[0].MyATK_status;
                    button1.Image = NullCard; 
                    label1.Text = ""; label2.Text = "";
                ...
                if (button2.Enabled == false && Magicbool2 == 0)
                {
                    pictureBox3.Image = button2.Image; Handbool2 = 0; Fildbool3 = 1;
                    label15.Text = label3.Text; label16.Text = label4.Text;
                    MyFild_status[2].FildHP_status = Mycardstatus[1].MyHP_status;
                    MyFild_status[2].FildATK_status = Mycardstatus[1].MyATK_status;
                    button2.Image = NullCard;
                    label3.Text = ""; label4.Text = "";
                    button8.Text = "필드에 카드가 있습니다";
                }
                if (button3.Enabled == false && Magicbool3 == 0)
                {
                    pictureBox3.Image = button3.Image; Handbool3 = 0; Fildbool3 = 1;
                    label15.Text = label5.Text; label16.Text = label6.Text;
                    MyFild_status[2].FildHP_status = Mycardstatus[2].MyHP_status;
                    MyFild_status[2].FildATK_status = Mycardstatus[2].MyATK_status;
                    button3.Image = NullCard; 
                    label5.Text = ""; label6.Text = "";
                    button8.Text = "필드에 카드가 있습니다";
                }
                if (button4.Enabled == false && Magicbool4 == 0)
                {
                    pictureBox3.Image = button4.Image; Handbool4 = 0; Fildbool3 = 1;
                    label15.Text = label7.Text; label16.Text = label8.Text;
                    MyFild_status[2].FildHP_status = Mycardstatus[3].MyHP_status;
                    MyFild_status[2].FildATK_status = Mycardstatus[3].MyATK_status;
                    button4.Image = NullCard;
                    label7.Text = ""; label8.Text = "";
                    button8.Text = "필드에 카드가 있습니다";
                }
                if (button5.Enabled == false && Magicbool5 == 0)
                {
                    pictureBox3.Image = button5.Image; Handbool5 = 0; Fildbool3 = 1;
                    label15.Text = label9.Text; label16.Text = label10.Text;
                    MyFild_status[2].FildHP_status = Mycardstatus[4].MyHP_status;
                    MyFild_status[2].FildATK_status = Mycardstatus[4].MyATK_status;
                    button5.Image = NullCard;
                    label9.Text = ""; label10.Text = "";
                    button8.Text = "필드에 카드가 있습니다";
                }
            ...
            if (button12.Visible == false && e.Button == MouseButtons.Left)
            {
                ...
                label15.Text = ""; label16.Text = ""; Fildbool3 = 0;
                MyFild_status[2].FildHP_status = 0; MyFild_status[2].FildATK_status = 0;
                Card_FildFull_Fildnull();
                button12.Visible = true; pictureBox3.Image = NullCard;
                textBox1.Text = "필드 세번째 카드를 버리셨습니다";
                textBox2.Text = Info_Card[2].Info_Fild = "";
                button12.Text = "카드 버리기 \r\n" + --DeleteCardcount + "/3";
            }
        }
        private void CardAdd4_button(object sender, MouseEventArgs e)
        {
            if(e.Button == MouseButtons.Left)
            {
                if (button1.Enabled == false && Magicbool1 == 0)
                {
                    pictureBox4.Image = button1.Image; Handbool1 = 0; Fildbool4 = 1;
                    label17.Text = label1.Text; label18.Text = label2.Text;
                    MyFild_status[3].FildHP_status = Mycardstatus[0].MyHP_status;
                    MyFild_status[3].FildATK_status = Mycardstatus[0].MyATK_status;
                    button1.Image = NullCard;
                    label1.Text = ""; label2.Text = "";
                ...
                if (button2.Enabled == false && Magicbool2 == 0)
                {
                    pictureBox4.Image = button2.Image; Handbool2 = 0; Fildbool4 = 1;
                    label17.Text = label3.Text; label18.Text = label4.Text;
                    MyFild_status[3].FildHP_status = Mycardstatus[1].MyHP_status;
                    MyFild_status[3].FildATK_status = Mycardstatus[1].MyATK_status;
                    button2.Image = NullCard;
                    label3.Text = ""; label4.Text = "";
                    button9.Text = "필드에 카드가 있습니다";
                }
                if (button3.Enabled == false && Magicbool3 == 0)
                {
                    pictureBox4.Image = button3.Image; Handbool3 = 0; Fildbool4 = 1;
                    label17.Text = label5.Text; label18.Text = label6.Text;
                    MyFild_status[3].FildHP_status = Mycardstatus[2].MyHP_status;
                    MyFild_status[3].FildATK_status = Mycardstatus[2].MyATK_status;
                    button3.Image = NullCard;
                    label5.Text = ""; label6.Text = "";
                    button9.Text = "필드에 카드가 있습니다";
                }
                if (button4.Enabled == false && Magicbool4 == 0)
                {
                    pictureBox4.Image = button4.Image; Handbool4 = 0; Fildbool4 = 1;
                    label17.Text = label7.Text; label18.Text = label8.Text;
                    MyFild_status[3].FildHP_status = Mycardstatus[3].MyHP_status;
                    MyFild_status[3].FildATK_status = Mycardstatus[3].MyATK_status;
                    button4.Image = NullCard;
                    label7.Text = ""; label8.Text = "";
                    button9.Text = "필드에 카드가 있습니다";
                }
                if (button5.Enabled == false && Magicbool5 == 0)
                {
                    pictureBox4.Image = button5.Image; Handbool5 = 0; Fildbool4 = 1;
                    label17.Text = label9.Text; label18.Text = label10.Text;
                    MyFild_status[3].FildHP_status = Mycardstatus[4].MyHP_status;
                    MyFild_status[3].FildATK_status = Mycardstatus[4].MyATK_status;
                    button5.Image = NullCard;
                    label9.Text = ""; label10.Text = "";
                    button9.Text = "필드에 카드가 있습니다";
                }
            ...
            if (button12.Visible == false && e.Button == MouseButtons.Left)
            {
                ...
                label17.Text = ""; label18.Text = ""; Fildbool4 = 0;
                MyFild_status[3].FildHP_status = 0; MyFild_status[3].FildATK_status = 0;
                Card_FildFull_Fildnull();
                button12.Visible = true; pictureBox4.Image = NullCard;
                textBox1.Text = "필드 네번째 카드를 버리셨습니다";
                textBox2.Text = Info_Card[3].Info_Fild = "";
                button12.Text = "카드 버리기 \r\n" + --DeleteCardcount + "/3";
            }
        }
        private void CardAdd5_button(object sender, MouseEventArgs e)
        {
            if(e.Button == MouseButtons.Left)
            {
                if (button1.Enabled == false && Magicbool1 == 0)
                {
                    pictureBox5.Image = button1.Image; Handbool1 = 0; Fildbool5 = 1;
                    label19.Text = label1.Text; label20.Text = label2.Text;
                    MyFild_status[4].FildHP_status = Mycardstatus[0].MyHP_status;
                    MyFild_status[4].FildATK_status = Mycardstatus[0].MyATK_status;
                    button1.Image = NullCard;
                    label1.Text = ""; label2.Text = "";
                ...
                if (button2.Enabled == false && Magicbool2 == 0)
                {
                    pictureBox5.Image = button2.Image; Handbool2 = 0; Fildbool5 = 1;
                    label19.Text = label3.Text; label20.Text = label4.Text;
                    MyFild_status[4].FildHP_status = Mycardstatus[1].MyHP_status;
                    MyFild_status[4].FildATK_status = Mycardstatus[1].MyATK_status;
                    button2.Image = NullCard;
                    label3.Text = ""; label4.Text = "";
                    button10.Text = "필드에 카드가 있습니다";
                }
                if (button3.Enabled == false && Magicbool3 == 0)
                {
                    pictureBox5.Image = button3.Image; Handbool3 = 0; Fildbool5 = 1;
                    label19.Text = label5.Text; label20.Text = label6.Text;
                    MyFild_status[4].FildHP_status = Mycardstatus[2].MyHP_status;
                    MyFild_status[4].FildATK_status = Mycardstatus[2].MyATK_status;
                    button3.Image = NullCard;
                    label5.Text = ""; label6.Text = "";
                    button10.Text = "필드에 카드가 있습니다";
                }
                if (button4.Enabled == false && Magicbool4 == 0)
                {
                    pictureBox5.Image = button4.Image; Handbool4 = 0; Fildbool5 = 1;
                    label19.Text = label7.Text; label20.Text = label8.Text;
                    MyFild_status[4].FildHP_status = Mycardstatus[3].MyHP_status;
                    MyFild_status[4].FildATK_status = Mycardstatus[3].MyATK_status;
                    button4.Image = NullCard;
                    label7.Text = ""; label8.Text = "";
                    button10.Text = "필드에 카드가 있습니다";
                }
                if (button5.Enabled == false && Magicbool5 == 0)
                {
                    pictureBox5.Image = button5.Image; Handbool5 = 0; Fildbool5 = 1;
                    label19.Text = label9.Text; label20.Text = label10.Text;
                    MyFild_status[4].FildHP_status = Mycardstatus[4].MyHP_status;
                    MyFild_status[4].FildATK_status = Mycardstatus[4].MyATK_status;
                    button5.Image = NullCard;
                    label9.Text = ""; label10.Text = "";
                    button10.Text = "필드에 카드가 있습니다";
                }
            ...
            if (button12.Visible == false && e.Button == MouseButtons.Left)
            {
                ...
                label19.Text = ""; label20.Text = ""; Fildbool5 = 0;
                MyFild_status[4].FildHP_status = 0; MyFild_status[4].FildATK_status = 0;
                Card_FildFull_Fildnull();
                button12.Visible = true; pictureBox5.Image = NullCard;
                textBox1.Text = "필드 다섯번째 카드를 버리셨습니다";
                textBox2.Text = Info_Card[4].Info_Fild = "";
                button12.Text = "카드 버리기 \r\n" + --DeleteCardcount + "/3";
            }
        }
        private void Card1_button(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (button12.Visible == false && e.Button == MouseButtons.Left && Handbool1 == 1)
                {
                    ...
                    Card_FildFull_Fildnull(); button12.Visible = true;
                }
